"""
Django settings for bgtrails project.
...
SECRET_KEY = '%t%bv(f=v2pk%__-2mexko$arr2y^tfi1)!i!kq*o@&m6%se3w'
...
WSGI_APPLICATION = 'bgtrails.wsgi.application'
